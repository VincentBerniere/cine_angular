...
describe('Service: serviceAjax', function () {
  ...
  it('should make a request to the right URL when callling similar function', function () {
    serviceAjax.similar(23401, 1);

    httpBackend.expectGET('http://localhost:3000/similar/23401?page=1').respond({});
